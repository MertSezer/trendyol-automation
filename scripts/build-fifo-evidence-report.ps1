...
$reportPath = Join-Path $outputDir "fifo-evidence.html"
...
[void]$sb.AppendLine("<!doctype html><html lang='tr'><head><meta charset='utf-8'><title>FIFO Evidence</title>")
...
[void]$sb.AppendLine("<h1>FIFO Cart Evidence Report</h1>")
